...
export const MEDIA_ITEMS: MediaItem[] = [
  ...
  },
  {
    ...
    body: [
      "Continua Media sits down with Equity Group's CEO to discuss the bank's newest subsidiary, the regional growth roadmap, and how management is thinking about capital allocation over the next three years.",
