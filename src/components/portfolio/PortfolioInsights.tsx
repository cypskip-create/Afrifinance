    ...
    <Card className="soft-card">
      <CardContent className="p-4 space-y-3">
        ...
        <div className="grid grid-cols-2 gap-2 pt-1">
          <div className="bg-bull/10 rounded-xl p-2.5">
