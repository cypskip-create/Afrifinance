...
export const historicalApi = {
  getCandles(
    ...
    return afriFinanceFetch<Candle[]>(`/historical/${encodeURIComponent(symbol)}`, {
  ...
  getPerformance(symbol: string, from: string, opts: { to?: string; exchange?: string } = {}) {
    ...
    return afriFinanceFetch<RangePerformance>(`/historical/${encodeURIComponent(symbol)}/performance`, {
