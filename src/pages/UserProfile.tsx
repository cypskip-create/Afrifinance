...
import { ArrowLeft, Calendar, Settings, UserPlus, UserMinus, MessageCircle, MoreHorizontal, Lock, Verified, Heart, Repeat2, FileText, Bookmark, Camera, Loader2, Share } from "lucide-react";
...
export default function UserProfile() {
  ...
  const fetchProfile = async () => {
    ...
    try {
      // Always use profiles_public for viewing any profile (protects email)
      // This works for both own profile and other users
      ...
      if (data) {
        ...
        // If not found in public view, try the main profiles table (for newly created profiles)
        ...
        if (fallbackData) {
          setProfile(fallbackData as UserProfileData);
        }
      }
    } catch (err) {
  ...
  const renderPost = (post: UserPost, showAuthor: boolean = false) => (
    <div key={post.id} className="p-3 sm:p-4 border-b border-border hover:bg-muted/20 transition-colors">
      <div className="flex gap-2.5 sm:gap-3">
        <Avatar 
          className="h-9 w-9 sm:h-10 sm:w-10 cursor-pointer shrink-0" 
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1 flex-wrap">
            <span 
              className="font-semibold text-sm cursor-pointer hover:underline truncate max-w-[140px] sm:max-w-none"
              onClick={() => navigate(`/profile/${showAuthor ? post.user_id : profile?.user_id}`)}
            >
    ...
    return (
      <div className="min-h-screen bg-background pb-20">
        ...
        <div className="p-4 text-center text-muted-foreground">
          ...
          <Button variant="outline" className="mt-4" onClick={() => navigate('/traders-hub')}>
            Back to TradersHub
          </Button>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
          ...
          <div className="flex items-center gap-2 sm:gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <h1 className="font-bold flex items-center gap-1 text-sm sm:text-base truncate">
                ...
                <Verified className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-primary fill-primary shrink-0" />
              </h1>
      ...
      <div className="relative">
        {/* Banner */}
        <div className="relative h-28 sm:h-32 bg-gradient-primary overflow-hidden">
          {profile.banner_url && (
        ...
        <div className="px-3 sm:px-4 -mt-14 sm:-mt-16">
          ...
          <div className="mt-3 sm:mt-4">
            ...
            {profile.bio && <p className="mt-2 sm:mt-3 text-sm leading-relaxed">{profile.bio}</p>}
        ...
        <div className="mx-3 sm:mx-4 mt-4">
          <Card className="bg-muted/30 border-dashed">
            <CardContent className="p-4 text-center">
              <Lock className="h-6 w-6 sm:h-8 sm:w-8 mx-auto mb-2 text-muted-foreground" />
              <p className="text-xs sm:text-sm text-muted-foreground">This user's portfolio is private</p>
            </CardContent>
          </Card>
        </div>
      )}
      ...
      <Tabs defaultValue="posts" className="mt-4">
        <TabsList className="w-full grid grid-cols-4 bg-transparent border-b border-border rounded-none h-11">
          <Tooltip>
            <TooltipTrigger asChild>
              <TabsTrigger value="posts" className="rounded-none border-b-2 border-transparent data-[state=active]:border-primary data-[state=active]:bg-transparent h-full">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <TabsTrigger value="replies" className="rounded-none border-b-2 border-transparent data-[state=active]:border-primary data-[state=active]:bg-transparent h-full">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <TabsTrigger value="reposts" className="rounded-none border-b-2 border-transparent data-[state=active]:border-primary data-[state=active]:bg-transparent h-full">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <TabsTrigger value="likes" className="rounded-none border-b-2 border-transparent data-[state=active]:border-primary data-[state=active]:bg-transparent h-full">
        ...
        <TabsContent value="reposts" className="mt-0">
          {repostedPosts.length === 0 ? (
            <div className="p-8 text-center text-muted-foreground">
              <Repeat2 className="h-10 w-10 sm:h-12 sm:w-12 mx-auto mb-3 opacity-50" />
